package com.bluboy.android.presentation.imagePickerCropper
...
import com.bluboy.android.databinding.ActivityCropResultBinding
...
class SCropResultActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.resultImageView.setBackgroundResource(R.drawable.gradient_home_game_b)
