 ...
 */
public abstract class BlurDialogNotCloseFragment extends DialogFragment {

    private static final String TAG = BlurDialogNotCloseFragment.class.getSimpleName();

    public static final int DEFAULT_ANIM_DURATION = 50;
    ...
    /*override fun onStart() {
        ...
        dialog?.window?.let {
            ...
            it.setLayout(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT)
        }
    ...
    private void startEnterAnimation() {
        if (blurImgView != null) {
            ViewUtil.animateAlpha(blurImgView, 0f, 1f, 400, null);
        }
    }
