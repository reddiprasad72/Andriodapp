 ...
 * 01/04/2017
 */
public class PinViewMobile extends AppCompatEditText {

    private static final String TAG = "PinViewMobile";
    ...
    public PinViewMobile(Context context) {
        this(context, null);
    }

    public PinViewMobile(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.pinViewStyle);
    }

    public PinViewMobile(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.PinViewMobile, defStyleAttr, 0);
...
//        </attr>-->
        mPinItemCount = a.getInt(R.styleable.PinViewMobile_itemCount, DEFAULT_COUNT);
        mPinItemHeight = (int) a.getDimension(R.styleable.PinViewMobile_itemHeight,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(R.styleable.PinViewMobile_itemWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.PinViewMobile_itemSpacing,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.PinViewMobile_itemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.PinViewMobile_lineWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.PinViewMobile_lineColor);
        isCursorVisible = a.getBoolean(R.styleable.PinViewMobile_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.PinViewMobile_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.PinViewMobile_cursorWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_cursor_width));

        mItemBackground = a.getDrawable(R.styleable.PinViewMobile_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(R.styleable.PinViewMobile_hideLineWhenFilled, false);
