...
import com.bluboy.android.databinding.FragmentTransactionBinding
...
//        Handler(Looper.getMainLooper()).postDelayed({
        homeViewModel.walletWinningTransaction(page)
//        },100)
    }

    private fun observer() {
        homeViewModel.walletHistoryWinObserver.observe(this, Observer {
            isInProgress = false
//                hideProgress()
